...
- [xeno-mcp](#xeno-mcp)
  ...
  - [Setup — Generic Mode](#setup--generic-mode)
    ...
    - [Autoexec (optional)](#autoexec-optional)
  - [MCP Configuration](#mcp-configuration)
    - [Xeno Mode](#xeno-mode)
    - [Generic Mode](#generic-mode)
    - [Optional: Shared Secret](#optional-shared-secret)
  - [Tools](#tools)
    - [Core Tools](#core-tools)
    - [ScriptBlox Integration](#scriptblox-integration)
    - [Remote Spy Tools](#remote-spy-tools)
    - [Game Scanner Tools](#game-scanner-tools)
  - [Remote Spy](#remote-spy)
    - [Requirements](#requirements-1)
    - [How It Works](#how-it-works)
    - [Deduplication](#deduplication)
    - [Querying Spy Logs](#querying-spy-logs)
    - [Cleanup](#cleanup)
  - [Game Scanner](#game-scanner)
    - [What Gets Scanned](#what-gets-scanned)
    - [Outline-First Approach](#outline-first-approach)
